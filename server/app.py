...
"""
FastAPI application for the Sst Hackathon Env Environment.

This module creates an HTTP server that exposes the SstHackathonEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m SST_hackathon_env.server.app
    ...
    multiple workers:
        uvicorn SST_hackathon_env.server.app:app --workers 4
    """
    import uvicorn
